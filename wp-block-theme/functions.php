...
function olon_block_theme_enqueue() {
    ...
    $bolt_key = defined('BoltDatabase_ANON_KEY') ? BoltDatabase_ANON_KEY : ( defined('Bolt_Database_ANON_KEY') ? Bolt_Database_ANON_KEY : '' );

    wp_localize_script('olon-main', 'OLON_CONFIG', array(
        // unspaced
        'BoltDatabaseUrl' => $bolt_url,
        'BoltDatabaseAnonKey' => $bolt_key,
        // spaced variants
        'Bolt DatabaseUrl' => $bolt_url,
        'Bolt DatabaseAnonKey' => $bolt_key,
        // camelCase spaced variant used in some JS
        'Bolt DatabaseUrl' => $bolt_url,
        'Bolt DatabaseAnonKey' => $bolt_key,
