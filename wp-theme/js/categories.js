async function loadCategories() {
  ...
  grid.innerHTML = categories.map(cat => `
    <a href="/category/${cat.slug}" class="category-card" 
       ...
       data-slug="${cat.slug}">
      <img src="${base}/assets/images/${cat.icon_up}" alt="${cat.name}" class="category-icon" 
           data-hover="${base}/assets/images/${cat.icon_hover}"
           data-up="${base}/assets/images/${cat.icon_up}">
